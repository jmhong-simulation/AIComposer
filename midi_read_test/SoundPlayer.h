...
*/
	...
	void readWavFileSequence(const std::string& filename_sequence, const int& start_ix, const int& end_ix, const bool& test_play = false);

	bool addWav(const std::string& key_name, std::string& file_name)
	{
